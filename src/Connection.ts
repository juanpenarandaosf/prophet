...
export default class Connection {
  ...
  public makeRequest<T>(options, cb: (resolve, reject, body) => void): Promise<T> {
    if (this.verbose) {
  ...
  public getStackTrace(threadID): Promise<IStackFrame[]> {
  ...
  public getMembers(threadID, frame_index, path?, start = 0, count = 100): Promise<IMember[]> {
    // get all variables
  ...
  public createBreakpoints(breakpoints): Promise<Array<{ id, file, line }>> {
    return this.makeRequest({
      uri: "/breakpoints",
      method: "POST",
      json: {
  ...
  public getBreakpoints(id?): Promise<Array<{ id, file, line }>> {
    return this.makeRequest({
  ...
  public getThreads(): Promise<IThread[]> {
    return this.makeRequest({
      uri: "/threads",
      method: "GET",
    }, (resolve, reject, body) => {
  ...
  public getVariables(threadID: number, frame_index: number, start = 0, count = 100): Promise<IVariable[]> {
  ...
  public stepInto(threadID): Promise<IThread> {
  ...
  public stepOut(threadID): Promise<IThread> {
  ...
  public stepOver(threadID): Promise<IThread> {
  ...
  public resume(threadID): Promise<IThread> {
  ...
  public evaluate(threadID, expr = "this", frameNo = 0): Promise<string> {
    return this.makeRequest({
