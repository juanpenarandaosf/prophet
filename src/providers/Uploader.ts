...
import { commands, ExtensionContext, OutputChannel, window, workspace, WorkspaceFolder } from "vscode";
...
export default class Uploader {
	...
	public static initialize(context: ExtensionContext, workspaceFolder$$: Observable<Observable<WorkspaceFolder>>) {
	...
	public async askCleanCartridge(fileNamesOnSandbox: string[], cartridgesToUpload: string[]): Promise<string[]> {
